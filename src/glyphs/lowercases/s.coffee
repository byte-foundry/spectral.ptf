		...
		0:
			...
			nodes:
				...
				3:
					...
					dirOut: Math.min(
						Math.PI,
						Utils.lineAngle({x: contours[0].nodes[2].expandedTo[0].x, y: contours[0].nodes[2].expandedTo[0].y}, {x: contours[0].nodes[4].expandedTo[1].x, y: contours[0].nodes[4].expandedTo[1].y}) + (18 / 180 * Math.PI)
					)
					type: 'smooth'
					tensionIn: 1.1
					tensionOut: 1.1
					expand:
						...
						angle: Utils.lineAngle({x: contours[0].nodes[2].expandedTo[0].x, y: contours[0].nodes[2].expandedTo[0].y}, {x: contours[0].nodes[4].expandedTo[1].x, y: contours[0].nodes[4].expandedTo[1].y}) + Math.PI / 2 - (5 / 180 * Math.PI)
						distr: 0.5
				4:
