exports.glyphs['Ч_cap'] =
	unicode: 'Ч'
	glyphName: 'Ч'
	characterName: 'CYRILLIC CAPITAL LETTER Ч'
	ot:
	...
	parameters:
		spacingLeft: 50 * spacing + 17 + ( 80 / 65 ) * serifWidth
	...
	contours:
		...
		1:
			...
			nodes:
				0:
					x: Math.max(
						contours[0].nodes[0].expandedTo[0].x + 286 + 200 * width - (22),
