exports.glyphs['и'] =
	unicode: 'и'
	glyphName: 'и'
	characterName: 'CYRILLIC SMALL LETTER и'
	ot:
		...
		2:
			...
			nodes:
				0:
					...
					y: xHeight - Math.min( ( 83 / 450 ) * xHeight , serifHeight + ( 45 / 450 ) * xHeight ) + (50 * contrast - 50)
					typeOut: 'line'
					expand:
				...
				1:
					...
					y: Math.min( ( 83 / 450 ) * xHeight , serifHeight + ( 45 / 450 ) * xHeight ) - (50 * contrast - 50)
					typeIn: 'line'
					expand:
						width: ( 43 / 80 ) * thickness * contrast
