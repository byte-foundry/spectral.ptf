exports.glyphs['г'] =
	unicode: 'г'
	glyphName: 'г'
	characterName: 'CYRILLIC SMALL LETTER г'
	ot:
			...
			nodes:
				0:
					...
					expand:
						...
						distr: 0
				1:
					x: contours[0].nodes[0].expandedTo[0].x + 114 + 200 * width + Math.max( 0, ( 20 / 80 ) * thickness - 20 )
	...
	components:
		...
		3:
			...
			transforms: Array(
				[ 'translateX', - ( Math.tan( (- (15 * 2) * serifRotate ) / 180 * Math.PI ) * ( ( 50 / 80 ) * thickness * contrast * 0.5 ) ) ]
			)
			parameters:
