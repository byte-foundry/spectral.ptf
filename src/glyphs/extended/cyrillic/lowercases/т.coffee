exports.glyphs['т'] =
	unicode: 'т'
	glyphName: 'т'
	characterName: 'CYRILLIC SMALL LETTER т'
	ot:
			...
			nodes:
				0:
					...
					expand:
						...
						distr: 0
				1:
					x: contours[0].nodes[0].x + 232 + 200 * width + Math.max( 0, ( 20 / 80 ) * thickness - 20 )
					y: xHeight
					typeOut: 'line'
					expand:
						width: ( 47 / 80 ) * thickness * contrast
	...
	components:
		...
		2:
			...
			transforms: Array(
				[ 'scaleY', -1 ],
				[ 'scaleX', -1 ],
				[ 'translateX', - ( Math.tan( (- (15 * 2) * serifRotate ) / 180 * Math.PI ) * ( ( 47 / 80 ) * thickness * contrast * 0.5 ) ) ]
			)
		3:
