exports.glyphs['м'] =
	unicode: 'м'
	glyphName: 'м'
	characterName: 'CYRILLIC SMALL LETTER м'
	ot:
	...
	contours:
		0:
			...
			nodes:
				...
				1:
					...
					typeIn: 'line'
					expand:
						width: ( 49 / 80 ) * thickness * contrast
						angle: 0
						distr: 0.25
		1:
			skeleton: true
			...
			nodes:
				0:
					x: contours[0].nodes[0].expandedTo[0].x + ( contours[2].nodes[0].expandedTo[0].x - contours[0].nodes[0].expandedTo[0].x ) * ( 225 / 500 )
		...
		2:
			...
			nodes:
				0:
					x: contours[0].nodes[0].expandedTo[0].x + 300 + 200 * width - (20)
					y: Math.max( 0, serifHeight * serifArc )
					typeOut: 'line'
					expand:
						width: ( 78 / 80 ) * thickness
		...
		3:
			...
			nodes:
				0:
					x: contours[1].nodes[0].expandedTo[0].x + ( 21 / 80 ) * thickness
